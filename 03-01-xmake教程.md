...
![](resource/image/compile/xmake_1.png)
...
![](resource/image/compile/xmake_2.png)
...
![](resource/image/compile/xmake_3.png)
...
接下来，我们开始编译这个工程，只需要进入项目根目录下，然后执行 `xmake` 命令就可以完成编译。
  ...
  ![](resource/image/compile/xmake_7.png)

  编译完成后，再执行 `tree` 命令，查看 xmake 生成了哪些文件。

  ![](resource/image/compile/xmake_8.png)
...
![](resource/image/compile/xmake_9.png)
...
![](resource/image/compile/xmake_10.png)
...
![](resource/image/compile/xmake_11.png)
...
![](resource/image/compile/xmake_12.png)
...
![](resource/image/compile/xmake_13.png)

执行 `which hello` 查看安装好的程序存放在系统的哪个路径下。

![](resource/image/compile/xmake_14.png)
...
![](resource/image/compile/xmake_15.png)

我们也可以继续使用 `which hello` 来继续确认是否卸载成功，如果看到 `Not Found` 字样，说明程序已经成功被卸载掉了。

![](resource/image/compile/xmake_16.png)
...
![](resource/image/compile/xmake_17.png)
...
![](resource/image/compile/xmake_18.png)
...
![](resource/image/compile/xmake_19.png)
...
![](resource/image/compile/xmake_20.png)

如果配置成功，通过下面的命令查看当前的配置信息，确认是否生效。

![](resource/image/compile/xmake_21.png)
...
![](resource/image/compile/xmake_22.png)
...
![](resource/image/compile/xmake_23.png)
...
![](resource/image/compile/xmake_24.png)
...
![](resource/image/compile/xmake_25.png)

我们再通过 `xmake run` 运行下编译好的目标程序。

![](resource/image/compile/xmake_26.png)
...
![](resource/image/compile/xmake_27.png)
...
![](resource/image/compile/xmake_28.png)
...
![](resource/image/compile/xmake_29.png)
...
![](resource/image/compile/xmake_32.svg)
...
![](resource/image/compile/xmake_33.png)
...
![](resource/image/compile/xmake_34.png)
...
![](resource/image/compile/xmake_35.png)
...
![](resource/image/compile/xmake_36.png)

然后我们执行 `xmake run` 运行下这个程序。

![](resource/image/compile/xmake_37.png)
...
![](resource/image/compile/xmake_38.png)
...
![](resource/image/compile/xmake_39.png)
...
![](resource/image/compile/xmake_40.png)
...
![](resource/image/compile/xmake_41.png)
...
![](resource/image/compile/xmake_42.png)
...
![](resource/image/compile/xmake_43.png)
...
![](resource/image/compile/xmake_44.png)
...
![](resource/image/compile/xmake_45.png)
...
![](resource/image/compile/xmake_46.png)
...
![](resource/image/compile/xmake_47.png)
...
![](resource/image/compile/xmake_48.png)
...
![](resource/image/compile/xmake_49.png)
...
![](resource/image/compile/xmake_50.png)
...
![](resource/image/compile/xmake_51.png)
...
![](resource/image/compile/xmake_52.png)
...
![](resource/image/compile/xmake_53.png)
...
![](resource/image/compile/xmake_54.png)
...
![](resource/image/compile/xmake_55.png)
...
![](resource/image/compile/xmake_56.png)
...
![](resource/image/compile/xmake_57.png)
...
![](resource/image/compile/xmake_58.png)
...
![图片描述](resource/image/compile/xmake_59.png)

再来执行 `xmake -rv` 查看完整命令输出，看看是否真的集成上了这两个库。

![](resource/image/compile/xmake_60.png)
...
![](resource/image/compile/xmake_61.png)
...
![](resource/image/compile/xmake_62.png)
...
![](resource/image/compile/xmake_63.png)

如果安装成功，可以继续执行 `xmake -rv` 来查看 xmake 实际链接的 conan 包路径信息。

![](resource/image/compile/xmake_64.png)
...
![](resource/image/compile/xmake_65.png)
...
![](resource/image/compile/xmake_66.png)
...
![](resource/image/compile/xmake_67.png)
...
![](resource/image/compile/xmake_68.png)
...
![](resource/image/compile/xmake_69.png)
...
![](resource/image/compile/xmake_70.png)

再执行 `xmake -rv` 查看详细输出，这两个宏定义已经分别传入了对应的 target 中去。

![](resource/image/compile/xmake_71.png)
...
![](resource/image/compile/xmake_72.png)
...
![](resource/image/compile/xmake_73.png)
...
![](resource/image/compile/xmake_74.png)
...
![](resource/image/compile/xmake_75.png)
...
![](resource/image/compile/xmake_76.png)
...
![](resource/image/compile/xmake_77.png)
...
![](resource/image/compile/xmake_78.png)
...
![](resource/image/compile/xmake_79.png)
...
![](resource/image/compile/xmake_80.png)
...
![](resource/image/compile/xmake_81.png)
...
![](resource/image/compile/xmake_84.png)
...
![](resource/image/compile/xmake_85.png)
...
![](resource/image/compile/xmake_86.png)
...
![](resource/image/compile/xmake_87.png)
...
![](resource/image/compile/xmake_88.png)
...
![](resource/image/compile/xmake_89.png)
...
![](resource/image/compile/xmake_90.png)
...
![](resource/image/compile/xmake_91.png)
...
![](resource/image/compile/xmake_92.png)
...
![](resource/image/compile/xmake_93.png)
...
![](resource/image/compile/xmake_94.png)
...
![](resource/image/compile/xmake_95.png)
...
![](resource/image/compile/xmake_96.png)
...
![](resource/image/compile/xmake_97.png)
...
![](resource/image/compile/xmake_98.png)
...
![](resource/image/compile/xmake_99.png)
...
![](resource/image/compile/xmake_100.png)
...
![](resource/image/compile/xmake_101.png)
...
![](resource/image/compile/xmake_102.png)
...
![](resource/image/compile/xmake_103.png)
...
![](resource/image/compile/xmake_104.png)
...
![](resource/image/compile/xmake_105.png)
...
![](resource/image/compile/xmake_106.png)

执行 `xmake -rv` 来验证刚刚的配置结果。

![](resource/image/compile/xmake_107.png)
...
![](resource/image/compile/xmake_108.png)
...
![](resource/image/compile/xmake_109.png)
...
![](resource/image/compile/xmake_110.png)
...
![2](resource/image/compile/xmake_111.png)
...
![](resource/image/compile/xmake_114.png)
...
![](resource/image/compile/xmake_115.png)
...
![](resource/image/compile/xmake_123.png)
...
![](resource/image/compile/xmake_124.png)
...
![](resource/image/compile/xmake_125.png)
...
![](resource/image/compile/xmake_126.png)
...
![](resource/image/compile/xmake_127.png)
...
![](resource/image/compile/xmake_131.png)
...
![](resource/image/compile/xmake_132.png)
...
![](resource/image/compile/xmake_133.png)
...
![](resource/image/compile/xmake_134.png)
...
![](resource/image/compile/xmake_135.png)
...
![](resource/image/compile/xmake_136.png)
...
![](resource/image/compile/xmake_137.png)
...
![](resource/image/compile/xmake_138.png)
...
![](resource/image/compile/xmake_139.png)
...
![](resource/image/compile/xmake_140.png)

运行 `xmake run` 继续确认下输出结果是否真的被改写为 `hello xmake!`，如下图。

![](resource/image/compile/xmake_141.png)
...
![](resource/image/compile/xmake_142.png)
...
![](resource/image/compile/xmake_143.png)
...
![](resource/image/compile/xmake_144.png)

而如果输入 `n`，编译过程就被中断了。

![](resource/image/compile/xmake_145.png)
...
![](resource/image/compile/xmake_146.png)
...
![](resource/image/compile/xmake_147.png)
...
![](resource/image/compile/xmake_148.png)
...
![](resource/image/compile/xmake_149.png)
...
![](resource/image/compile/xmake_150.png)
...
![](resource/image/compile/xmake_151.png)
...
![](resource/image/compile/xmake_152.png)
...
![](resource/image/compile/xmake_153.png)
...
![](resource/image/compile/xmake_154.png)
...
![](resource/image/compile/xmake_155.png)
...
![](resource/image/compile/xmake_156.png)
...
![](resource/image/compile/xmake_157.png)
...
![](resource/image/compile/xmake_158.png)
...
![](resource/image/compile/xmake_159.png)
...
![](resource/image/compile/xmake_160.png)
...
![](resource/image/compile/xmake_161.png)
...
![](resource/image/compile/xmake_162.png)
...
![9](resource/image/compile/xmake_163.png)
...
![](resource/image/compile/xmake_164.png)

我们可以执行 `gvim ./makefile` 看下实际生成的 makefile 文件内容。

![](resource/image/compile/xmake_165.png)
...
![](resource/image/compile/xmake_168.png)
...
![](resource/image/compile/xmake_169.png)
...
![](resource/image/compile/xmake_170.png)
...
![](resource/image/compile/xmake_171.png)
...
![](resource/image/compile/xmake_172.png)
...
![](resource/image/compile/xmake_173.png)
...
![](resource/image/compile/xmake_174.png)
...
![](resource/image/compile/xmake_175.png)
...
![](resource/image/compile/xmake_176.png)
...
![](resource/image/compile/xmake_177.png)
...
![](resource/image/compile/xmake_178.png)
...
![](resource/image/compile/xmake_179.png)
...
![](resource/image/compile/xmake_180.png)
...
![](resource/image/compile/xmake_181.png)
...
![](resource/image/compile/xmake_182.png)
...
![](resource/image/compile/xmake_183.png)

编译成功完成后，xmake 会把构建生成产物放置在 `build/artifacts` 目录下，实际输出内容，如下图。

![](resource/image/compile/xmake_184.png)
...
![](resource/image/compile/xmake_185.png)

我们根据提示，按下 `y` 和回车后，xmake 就会开始自动扫描 libjpeg 库下的所有源文件，如图。

![](resource/image/compile/xmake_186.png)

还会扫描用到 libjpeg 库的一些可执行程序，如下图。

![](resource/image/compile/xmake_187.png)

然后继续编译，编译到一半的时候，触发了编译错误，看下图的错误信息，应该是编译 jmemmac.c 文件失败了。

![](resource/image/compile/xmake_188.png)
...
![](resource/image/compile/xmake_191.png)

注释掉这三个不相关的文件后，继续执行 xmake 命令就能顺利通过编译了，如下图。

![](resource/image/compile/xmake_192.png)
...
![](resource/image/compile/xmake_193.png)
...
![](resource/image/compile/xmake_194.png)
...
![](resource/image/compile/xmake_195.png)
...
![](resource/image/compile/xmake_196.png)
...
![](resource/image/compile/xmake_197.gif)
...
![](resource/image/compile/xmake_198.png)
...
![](resource/image/compile/xmake_207.png)
...
![](resource/image/compile/xmake_208.png)

#### 运行程序

编译完成后就可以尝试运行程序了，还是使用底下的工具栏按钮，点击运行图标，也就是下图红框中的按钮。

![](resource/image/compile/xmake_209.png)
...
![](resource/image/compile/xmake_210.png)

完成切换后可以看到底下的 release 按钮已经变成了 debug 字样，然后点击 build 按钮，就可以重新编译带有调试符号的目标程序了。

![](resource/image/compile/xmake_211.png)
...
![](resource/image/compile/xmake_214.png)
...
![](resource/image/compile/xmake_219.png)
...
![](resource/image/compile/xmake_220.png)
...
![](resource/image/compile/xmake_221.png)

然后再打开的命令面板中输入 xmake 过滤出所有跟 xmake 相关的命令列表，找到 Rebuild 命令后点击编译即可，如下图。

![](resource/image/compile/xmake_222.png)

开启 verbose 级别后，我们就能看到编译输出中完整的命令参数了，如下图。

![](resource/image/compile/xmake_223.png)
...
![](resource/image/compile/xmake_224.png)

完成配置后，我们再来点击底下的 Build 按钮执行编译，看下详细命令输出，应该能够正常看到新加上的 `-DTEST2` 宏定义了。

![](resource/image/compile/xmake_225.png)
...
![](resource/image/compile/xmake_226.png)
...
![](resource/image/compile/xmake_229.png)
...
![](resource/image/compile/xmake_230.png)
...
![](resource/image/compile/xmake_231.png)
...
![](resource/image/compile/xmake_232.png)

我们点击调试按钮，如果一切顺利，就会出现下图的界面，说明断点已经被正常触发了，可以单步调试了。

![](resource/image/compile/xmake_233.png)
...
![](resource/image/compile/xmake_243.png)
...
![](resource/image/compile/xmake_244.png)

然后再打开的命令面板中输入 xmake 过滤出所有跟 xmake 相关的命令列表，找到 Rebuild 命令后点击编译即可，如下图。

![](resource/image/compile/xmake_245.png)

最后点击运行，首次运行的效果如下，我们会额外看到一个 Button 按钮在窗口中。

![](resource/image/compile/xmake_246.png)

点击这个 Button 按钮，就会看到窗口的颜色开始随机变动了，如下图。

![](resource/image/compile/xmake_247.png)
...
![](resource/image/compile/xmake_248.png)
