...
<center>![](resource/image/compile/xmake_1.png)</center>
...
<center>![](resource/image/compile/xmake_2.png)</center>
#### xmake 安装
...
<center>![](resource/image/compile/xmake_3.png)</center>
...
<center>![](resource/image/compile/xmake_4.png)</center>
我们可以在项目根目录执行 `tree` 简单看下这个空项目里面有哪些文件。
<center>![](resource/image/compile/xmake_5.png)</center>
可以看到，除了 src 目录下的 C++ 源文件外，xmake 会在根目录生成一个 xmake.lua 文件，执行 `gvim xmake.lua` 使用 gvim 打开看下 xmake.lua 这个文件里面的内容。
<center>![](resource/image/compile/xmake_6.png)</center>
...
<center>![](resource/image/compile/xmake_7.png)</center>
  编译完成后，再执行 `tree` 命令，查看 xmake 生成了哪些文件。
<center>![](resource/image/compile/xmake_8.png)</center>
...
<center>![](resource/image/compile/xmake_9.png)</center>
...
<center>![](resource/image/compile/xmake_10.png)</center>
...
<center>![](resource/image/compile/xmake_11.png)</center>
...
<center>![](resource/image/compile/xmake_12.png)</center>
...
<center>![](resource/image/compile/xmake_13.png)</center>
执行 `which hello` 查看安装好的程序存放在系统的哪个路径下。
<center>![](resource/image/compile/xmake_14.png)</center>
...
<center>![](resource/image/compile/xmake_15.png)</center>
我们也可以继续使用 `which hello` 来继续确认是否卸载成功，如果看到 `Not Found` 字样，说明程序已经成功被卸载掉了。
<center>![](resource/image/compile/xmake_16.png)</center>
...
<center>![](resource/image/compile/xmake_17.png)</center>
...
输出内容如下。
<center>![](resource/image/compile/xmake_18.png)</center>
...
<center>![](resource/image/compile/xmake_19.png)</center>
...
<center>![](resource/image/compile/xmake_20.png)</center>
如果配置成功，通过下面的命令查看当前的配置信息，确认是否生效。
<center>![](resource/image/compile/xmake_21.png)</center>
#### 添加 C/C++ 编译选项
...
<center>![](resource/image/compile/xmake_22.png)</center>
#### 添加链接库和搜索路径
...
<center>![](resource/image/compile/xmake_23.png)</center>
...
<center>![](resource/image/compile/xmake_24.png)</center>
...
<center>![](resource/image/compile/xmake_25.png)</center>
我们再通过 `xmake run` 运行下编译好的目标程序。
<center>![](resource/image/compile/xmake_26.png)</center>
...
<center>![](resource/image/compile/xmake_27.png)</center>
...
<center>![](resource/image/compile/xmake_30.png)</center>
更新完成后，我们可以继续执行 `xmake --version` 确认下版本是否为最新版本，实际的版本号由于时间关系，会有所变动，毕竟 xmake 的版本迭代还是挺频繁的。
<center>![](resource/image/compile/xmake_31.png)</center>
...
大致的编译链接流程可以参考下图。
<center>![](resource/image/compile/xmake_32.svg)</center>
...
<center>![](resource/image/compile/xmake_33.png)</center>
...
<center>![](resource/image/compile/xmake_34.png)</center>
...
<center>![](resource/image/compile/xmake_35.png)</center>
...
<center>![](resource/image/compile/xmake_36.png)</center>
然后我们执行 `xmake run` 运行下这个程序。
<center>![](resource/image/compile/xmake_37.png)</center>
#### 动态库程序类型
...
编译运行结果也跟静态库基本一致。
<center>![](resource/image/compile/xmake_38.png)</center>
#### Phony 目标类型
...
<center>![](resource/image/compile/xmake_39.png)</center>
...
<center>![](resource/image/compile/xmake_40.png)</center>
...
<center>![](resource/image/compile/xmake_41.png)</center>
...
<center>![](resource/image/compile/xmake_42.png)</center>
#### 设置语言标准
...
<center>![](resource/image/compile/xmake_43.png)</center>
...
<center>![](resource/image/compile/xmake_44.png)</center>
...
<center>![](resource/image/compile/xmake_45.png)</center>
#### 过滤源文件
...
<center>![](resource/image/compile/xmake_46.png)</center>
...
<center>![](resource/image/compile/xmake_47.png)</center>
...
<center>![](resource/image/compile/xmake_48.png)</center>
...
<center>![](resource/image/compile/xmake_49.png)</center>
...
<center>![](resource/image/compile/xmake_50.png)</center>
...
<center>![](resource/image/compile/xmake_51.png)</center>
#### 自动查找系统库
...
<center>![](resource/image/compile/xmake_52.png)</center>
...
<center>![](resource/image/compile/xmake_53.png)</center>
...
<center>![](resource/image/compile/xmake_54.png)</center>
...
<center>![](resource/image/compile/xmake_55.png)</center>
...
<center>![](resource/image/compile/xmake_56.png)</center>
...
如果看到下图，说明已经成功卸载了安装包。
<center>![](resource/image/compile/xmake_57.png)</center>
...
<center>![](resource/image/compile/xmake_58.png)</center>
#### 语义版本设置
...
<center>![图片描述](resource/image/compile/xmake_59.png)</center>
再来执行 `xmake -rv` 查看完整命令输出，看看是否真的集成上了这两个库。
<center>![](resource/image/compile/xmake_60.png)</center>
...
相关的包信息说明可以参考下面的图片。
<center>![](resource/image/compile/xmake_61.png)</center>
...
<center>![](resource/image/compile/xmake_62.png)</center>
...
<center>![](resource/image/compile/xmake_63.png)</center>
如果安装成功，可以继续执行 `xmake -rv` 来查看 xmake 实际链接的 conan 包路径信息。
<center>![](resource/image/compile/xmake_64.png)</center>
...
<center>![](resource/image/compile/xmake_65.png)</center>
也可以通过下面描述的特征来快速区分：
...
xmake run
```
<center>![](resource/image/compile/xmake_66.png)</center>
...
<center>![](resource/image/compile/xmake_67.png)</center>
...
<center>![](resource/image/compile/xmake_68.png)</center>
#### 分离脚本域配置脚本
...
<center>![](resource/image/compile/xmake_69.png)</center>
...
<center>![](resource/image/compile/xmake_70.png)</center>
再执行 `xmake -rv` 查看详细输出，这两个宏定义已经分别传入了对应的 target 中去。
<center>![](resource/image/compile/xmake_71.png)</center>
分别运行这两个可执行程序查看输出。
...
<center>![](resource/image/compile/xmake_72.png)</center>
#### 全局配置和子配置
...
<center>![](resource/image/compile/xmake_73.png)</center>
...
执行 `xmake` 查看实际的编译顺序。
<center>![](resource/image/compile/xmake_74.png)</center>
...
<center>![](resource/image/compile/xmake_75.png)</center>
...
<center>![](resource/image/compile/xmake_76.png)</center>
...
<center>![](resource/image/compile/xmake_77.png)</center>
#### 级联依赖继承
...
<center>![](resource/image/compile/xmake_78.png)</center>
...
<center>![](resource/image/compile/xmake_79.png)</center>
...
<center>![](resource/image/compile/xmake_80.png)</center>
...
编译后的实际结果如下图。
<center>![](resource/image/compile/xmake_81.png)</center>
...
<center>![](resource/image/compile/xmake_82.png)</center>
...
<center>![](resource/image/compile/xmake_84.png)</center>
#### 判断宿主平台架构
...
xmake -rv
```
<center>![](resource/image/compile/xmake_88.png)</center>
...
xmake -rv
```
<center>![](resource/image/compile/xmake_89.png)</center>
#### 判断自定义配置选项
...
```
<center>![](resource/image/compile/xmake_90.png)</center>
...
<center>![](resource/image/compile/xmake_91.png)</center>
...
<center>![](resource/image/compile/xmake_92.png)</center>
...
<center>![](resource/image/compile/xmake_93.png)</center>
...
<center>![](resource/image/compile/xmake_94.png)</center>
...
<center>![](resource/image/compile/xmake_97.png)</center>
#### 执行获取 shell 输出内容
...
<center>![](resource/image/compile/xmake_98.png)</center>
...
<center>![](resource/image/compile/xmake_99.png)</center>
...
<center>![](resource/image/compile/xmake_100.png)</center>
...
<center>![](resource/image/compile/xmake_101.png)</center>
...
<center>![](resource/image/compile/xmake_102.png)</center>
...
<center>![](resource/image/compile/xmake_103.png)</center>
...
<center>![](resource/image/compile/xmake_104.png)</center>
...
整个继承结构可以参考下图所示。
<center>![](resource/image/compile/xmake_105.png)</center>
...
<center>![](resource/image/compile/xmake_106.png)</center>
执行 `xmake -rv` 来验证刚刚的配置结果。
<center>![](resource/image/compile/xmake_107.png)</center>
...
<center>![](resource/image/compile/xmake_108.png)</center>
...
<center>![](resource/image/compile/xmake_109.png)</center>
...
<center>![](resource/image/compile/xmake_110.png)</center>
#### 配置使用 C++ 预编译头文件
...
<center>![2](resource/image/compile/xmake_111.png)</center>
...
<center>![](resource/image/compile/xmake_114.png)</center>
...
<center>![](resource/image/compile/xmake_115.png)</center>
...
<center>![](resource/image/compile/xmake_121.png)</center>
编译通过后，我们再来看下 `build/config.h` 里面的内容，这时 `${define HAS_SETJMP}` 模板变量已经自动变成了 `#define HAS_SETJMP 1`，说明检测顺利通过。
<center>![](resource/image/compile/xmake_122.png)</center>
...
<center>![](resource/image/compile/xmake_123.png)</center>
...
<center>![](resource/image/compile/xmake_124.png)</center>
#### 配置自定义 C/C++ 代码片段检测
...
<center>![](resource/image/compile/xmake_125.png)</center>
...
<center>![](resource/image/compile/xmake_126.png)</center>
...
<center>![](resource/image/compile/xmake_127.png)</center>
...
<center>![](resource/image/compile/xmake_128.png)</center>
而当我们执行完 `xmake` 编译任务后，再执行 `xmake run` 命令查看实际的运行结果，会发现里面的输出字符串已经了变成 `hello xmake`，如下图所示。
<center>![](resource/image/compile/xmake_129.png)</center>
...
<center>![](resource/image/compile/xmake_131.png)</center>
...
<center>![](resource/image/compile/xmake_132.png)</center>
...
<center>![](resource/image/compile/xmake_133.png)</center>
...
<center>![](resource/image/compile/xmake_134.png)</center>
...
<center>![](resource/image/compile/xmake_135.png)</center>
...
<center>![](resource/image/compile/xmake_136.png)</center>
...
<center>![](resource/image/compile/xmake_137.png)</center>
#### 静默运行程序
...
<center>![](resource/image/compile/xmake_138.png)</center>
...
<center>![](resource/image/compile/xmake_139.png)</center>
...
<center>![](resource/image/compile/xmake_140.png)</center>
运行 `xmake run` 继续确认下输出结果是否真的被改写为 `hello xmake!`，如下图。
<center>![](resource/image/compile/xmake_141.png)</center>
...
<center>![](resource/image/compile/xmake_142.png)</center>
#### 序列化和反序列化
...
<center>![](resource/image/compile/xmake_143.png)</center>
...
<center>![](resource/image/compile/xmake_144.png)</center>
而如果输入 `n`，编译过程就被中断了。
<center>![](resource/image/compile/xmake_145.png)</center>
#### 打印标准输出
...
<center>![](resource/image/compile/xmake_146.png)</center>
...
执行 `xmake` 查看结果。
<center>![](resource/image/compile/xmake_147.png)</center>
...
执行后的效果如下图所示。
<center>![](resource/image/compile/xmake_148.png)</center>
...
<center>![](resource/image/compile/xmake_149.png)</center>
...
<center>![](resource/image/compile/xmake_150.png)</center>
...
<center>![](resource/image/compile/xmake_151.png)</center>
#### import 的模块查找顺序
...
<center>![](resource/image/compile/xmake_152.png)</center>
#### 在独立模块文件中导入
...
<center>![](resource/image/compile/xmake_153.png)</center>
#### 导入作为函数接口使用
...
<center>![](resource/image/compile/xmake_154.png)</center>
#### 导入模块包和别名
...
<center>![](resource/image/compile/xmake_155.png)</center>
...
<center>![](resource/image/compile/xmake_156.png)</center>
...
运行效果如下图。
<center>![](resource/image/compile/xmake_157.png)</center>
...
<center>![](resource/image/compile/xmake_158.png)</center>
...
<center>![](resource/image/compile/xmake_159.png)</center>
#### 执行指定 lua 字符串脚本
...
<center>![](resource/image/compile/xmake_160.png)</center>
#### 快速调用和测试模块接口
...
结果如下。
<center>![](resource/image/compile/xmake_161.png)</center>
...
<center>![](resource/image/compile/xmake_162.png)</center>
...
<center>![9](resource/image/compile/xmake_163.png)</center>
...
<center>![](resource/image/compile/xmake_164.png)</center>
我们可以执行 `gvim ./makefile` 看下实际生成的 makefile 文件内容。
<center>![](resource/image/compile/xmake_165.png)</center>
...
如果编译正常，会看到下图的输出结果。
<center>![](resource/image/compile/xmake_166.png)</center>
编译完成后，我们再来执行 `tree` 命令，查看实际通过 `make` 命令编译生成的可执行路径在哪里，从下图中，可以确认实际的输出路径跟通过 xmake 命令编译的结果完全一致。
<center>![](resource/image/compile/xmake_167.png)</center>
...
<center>![](resource/image/compile/xmake_168.png)</center>
#### 生成 CMakeLists.txt
...
编译和运行效果如下图。
<center>![](resource/image/compile/xmake_171.png)</center>
#### 实战之 tbox 工程编译
...
如果编译成功，会显示下面的信息。
<center>![](resource/image/compile/xmake_172.png)</center>
...
<center>![](resource/image/compile/xmake_173.png)</center>
...
<center>![](resource/image/compile/xmake_174.png)</center>
...
<center>![](resource/image/compile/xmake_175.png)</center>
...
<center>![](resource/image/compile/xmake_176.png)</center>
#### 传递外部参数给插件
...
<center>![](resource/image/compile/xmake_177.png)</center>
...
<center>![](resource/image/compile/xmake_178.png)</center>
#### 插件参数选项详解
...
<center>![](resource/image/compile/xmake_179.png)</center>
...
```
<center>![](resource/image/compile/xmake_180.png)</center>
...
```
<center>![](resource/image/compile/xmake_181.png)</center>
#### 内部任务的定义和使用
...
<center>![](resource/image/compile/xmake_182.png)</center>
...
<center>![](resource/image/compile/xmake_183.png)</center>
编译成功完成后，xmake 会把构建生成产物放置在 `build/artifacts` 目录下，实际输出内容，如下图。
<center>![](resource/image/compile/xmake_184.png)</center>
...
提示内容如下图所示。
<center>![](resource/image/compile/xmake_185.png)</center>
我们根据提示，按下 `y` 和回车后，xmake 就会开始自动扫描 libjpeg 库下的所有源文件，如图。
<center>![](resource/image/compile/xmake_186.png)</center>
还会扫描用到 libjpeg 库的一些可执行程序，如下图。
<center>![](resource/image/compile/xmake_187.png)</center>
然后继续编译，编译到一半的时候，触发了编译错误，看下图的错误信息，应该是编译 jmemmac.c 文件失败了。
<center>![](resource/image/compile/xmake_188.png)</center>
...
<center>![](resource/image/compile/xmake_189.png)</center>
删除后，我们继续执行 xmake 编译 libjpeg 项目，这个时候我们又发现了其它类似的编译错误，这回是 jmemdos.c 文件，似乎也是跟 libjpeg 的内存分配相关代码。
<center>![](resource/image/compile/xmake_190.png)</center>
...
<center>![](resource/image/compile/xmake_191.png)</center>
注释掉这三个不相关的文件后，继续执行 xmake 命令就能顺利通过编译了，如下图。
<center>![](resource/image/compile/xmake_192.png)</center>
#### 手动配置 xmake.lua 移植编译
...
<center>![](resource/image/compile/xmake_193.png)</center>
...
<center>![](resource/image/compile/xmake_194.png)</center>
...
<center>![](resource/image/compile/xmake_195.png)</center>
#### 配置文件的自动生成
...
<center>![](resource/image/compile/xmake_196.png)</center>
...
<center>![](resource/image/compile/xmake_197.gif)</center>
...
<center>![](resource/image/compile/xmake_198.png)</center>
#### 创建和打开 C/C++ 工程
...
<center>![](resource/image/compile/xmake_199.png)</center>
点击后，我们进入刚刚创建的 vscode_test 目录，选中并打开它。
<center>![](resource/image/compile/xmake_200.png)</center>
打开目录后，我们就可以开始创建工程文件了，继续进入菜单的 view 子菜单打开 vscode 里面的命令面板，如下图。
<center>![](resource/image/compile/xmake_201.png)</center>
命令面板打开后，我们输入 xmake 字符串，就会看到一系列跟 xmake 插件相关的命令，然后从其中找到带 `Create Project` 字样的命令，如图。
<center>![](resource/image/compile/xmake_202.png)</center>
这个时候，由于当前还没有 xmake.lua 文件，会在底下弹出一个提示框，继续点击里面的蓝色按钮。
<center>![](resource/image/compile/xmake_203.png)</center>
接着就会弹出编程语言的选择列表，这里选择第二项，也就是 C++ 语言。
<center>![](resource/image/compile/xmake_204.png)</center>
选择完语言后，还会提示选择工程类型，这里选择 console 终端程序类型。
<center>![](resource/image/compile/xmake_205.png)</center><center>![](resource/image/compile/xmake_206.png)</center>
...
<center>![](resource/image/compile/xmake_207.png)</center>
...
<center>![](resource/image/compile/xmake_208.png)</center>
#### 运行程序

编译完成后就可以尝试运行程序了，还是使用底下的工具栏按钮，点击运行图标，也就是下图红框中的按钮。
<center>![](resource/image/compile/xmake_209.png)</center>
...
<center>![](resource/image/compile/xmake_210.png)</center>
完成切换后可以看到底下的 release 按钮已经变成了 debug 字样，然后点击 build 按钮，就可以重新编译带有调试符号的目标程序了。
<center>![](resource/image/compile/xmake_211.png)</center>
...
<center>![](resource/image/compile/xmake_212.png)</center>
安装好 C/C++ 插件，就可以开始调试操作了。首先点击 main.cpp 打开源文件，然后在需要下断点的代码行左侧位置点击下断点，如果出现小红点，说明已经成功下好了调试断点，如下图。
<center>![](resource/image/compile/xmake_213.png)</center>
...
sudo apt install -y gdb
```
<center>![](resource/image/compile/xmake_214.png)</center>
...
<center>![](resource/image/compile/xmake_220.png)</center>
...
从下图的红色箭头位置找到对应的命令面板。
<center>![](resource/image/compile/xmake_221.png)</center>
然后再打开的命令面板中输入 xmake 过滤出所有跟 xmake 相关的命令列表，找到 Rebuild 命令后点击编译即可，如下图。
<center>![](resource/image/compile/xmake_222.png)</center>
开启 verbose 级别后，我们就能看到编译输出中完整的命令参数了，如下图。
<center>![](resource/image/compile/xmake_223.png)</center>
#### xmake.lua 编辑和自动补全
...
<center>![](resource/image/compile/xmake_224.png)</center>
完成配置后，我们再来点击底下的 Build 按钮执行编译，看下详细命令输出，应该能够正常看到新加上的 `-DTEST2` 宏定义了。
<center>![](resource/image/compile/xmake_225.png)</center>
...
<center>![](resource/image/compile/xmake_226.png)</center>
...
<center>![](resource/image/compile/xmake_227.png)</center>
然后执行 `xmake run` 命令运行编译生成的目标程序，如下图所示，一个可视化的空白窗口被显示出来，说明我们第一个 Qt Gui 程序已经构建运行完成。
<center>![](resource/image/compile/xmake_228.png)</center>
...
<center>![](resource/image/compile/xmake_229.png)</center>
#### 在 vscode 中开发 Qt 程序
...
如果看到下图所示内容，说明我们已经成功找到了 xmake-vscode 插件，然后点击旁边的 `Install` 字样按钮就可以完成安装了。
<center>![](resource/image/compile/xmake_230.png)</center>
...
<center>![](resource/image/compile/xmake_231.png)</center>
#### 在 vscode 中调试 Qt 程序
...
<center>![](resource/image/compile/xmake_232.png)</center>
我们点击调试按钮，如果一切顺利，就会出现下图的界面，说明断点已经被正常触发了，可以单步调试了。
<center>![](resource/image/compile/xmake_233.png)</center>
...
<center>![](resource/image/compile/xmake_240.png)</center>
改完后，我们就可以点击 Build 按钮编译这个 Qt Quick 程序了，如果编译通过，会显示下图的结果。
<center>![](resource/image/compile/xmake_241.png)</center>
编译通过后，我们再来点击运行按钮运行此程序，如果成功，会看到一个空白的窗口显示出来，就跟 Qt Widgets 的效果差不多。
<center>![](resource/image/compile/xmake_242.png)</center>
...
<center>![](resource/image/compile/xmake_243.png)</center>
...
从下图的红色箭头位置找到对应的命令面板。
<center>![](resource/image/compile/xmake_244.png)</center>
然后再打开的命令面板中输入 xmake 过滤出所有跟 xmake 相关的命令列表，找到 Rebuild 命令后点击编译即可，如下图。
<center>![](resource/image/compile/xmake_245.png)</center>
最后点击运行，首次运行的效果如下，我们会额外看到一个 Button 按钮在窗口中。
<center>![](resource/image/compile/xmake_246.png)</center>
点击这个 Button 按钮，就会看到窗口的颜色开始随机变动了，如下图。
<center>![](resource/image/compile/xmake_247.png)</center>
...
<center>![](resource/image/compile/xmake_248.png)</center>
