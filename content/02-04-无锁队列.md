...
```
<div align="center"><img src="resource/image/cxx/31.jpg" alt=""></div>
...
<div align="center"><img src="resource/image/cxx/32.jpg" alt=""></div>
    这时候，内存地址V中变量发生了多次改变，版本号提升为03，但是变量值仍然是A。
<div align="center"><img src="resource/image/cxx/33.jpg" alt=""></div>
    随后线程1恢复运行，进行compare操作。经过比较，线程1所获得的值和地址的实际值都是A，但是版本号不相等，所以这一次更新失败
<div align="center"><img src="resource/image/cxx/34.jpg" alt=""></div>
CAS的问题
