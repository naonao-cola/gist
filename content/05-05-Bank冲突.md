...
<center>![](resource/image/nvidia/nvi_7.png)</center>
共享内存分配方式
...
最优访问模式 并行不冲突
<center>![](resource/image/nvidia/nvi_8.png)</center>
不规则的访问 并行不冲突
<center>![](resource/image/nvidia/nvi_9.png)</center>
不规则的访问 当线程访问同一个bank中的不同地址时就会冲突，访问同一个bank中的相同地址时则以广播的方式
<center>![](resource/image/nvidia/nvi_10.png)</center>
...
```
<center>![](resource/image/nvidia/nvi_14.png)</center>
